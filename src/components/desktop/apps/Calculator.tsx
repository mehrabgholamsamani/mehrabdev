...
const Calculator = () => {
  ...
  const Button = ({
    ...
    <button
      onClick={onClick}
      className={`${wide ? 'col-span-2' : ''} h-14 rounded-full text-2xl font-light transition-all active:scale-95 active:brightness-75 flex items-center justify-center ${className}`}
    >
      {children}
    </button>
  );
  ...
  return (
    <div className="h-full flex flex-col bg-black p-4">
      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        <Button onClick={() => inputDigit('0')} wide className="bg-gray-700 text-white hover:bg-gray-600 justify-start pl-7">
          0
        </Button>
