...
const Terminal = ({ onOpenFile }: TerminalProps) => {
  const [currentPath, setCurrentPath] = useState('/home/mehrab');
  const [input, setInput] = useState('');
  const [history, setHistory] = useState<HistoryEntry[]>([
    { type: 'output', content: '\x1b[90mMehrab OS Terminal v1.0\x1b[0m' },
  ...
  const getPrompt = () => {
    ...
    return `\x1b[36mmehrab\x1b[0m@\x1b[35mportfolio\x1b[0m:\x1b[33m${displayPath}\x1b[0m$`;
  };
...
`);
      ...
      case 'neofetch':
        addOutput(`
\x1b[36m                  .,,,,,.                  \x1b[0m   \x1b[36mmehrab\x1b[0m@\x1b[35mportfolio\x1b[0m
\x1b[36m              ,#@@@@@@@@@@#,              \x1b[0m   \x1b[90m──────────────────────\x1b[0m
\x1b[36m           .@@@@@@@@@@@@@@@@@@.           \x1b[0m   \x1b[33mOS\x1b[0m:       Mehrab OS
...
\x1b[36m      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@      \x1b[0m
\x1b[36m      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@      \x1b[0m    \x1b[33mLocation\x1b[0m: Tampere, Finland
\x1b[36m      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@      \x1b[0m    \x1b[33mRole\x1b[0m:     Full-Stack Developer
\x1b[36m       @@@@@@@@@@@@@@@@@@@@@@@@@@@       \x1b[0m    \x1b[33mStack\x1b[0m:    React, TypeScript
\x1b[36m        @@@@@@@@@@@@@@@@@@@@@@@@@        \x1b[0m              Node.js, Express
\x1b[36m         '@@@@@@@@@@@@@@@@@@@@@@'         \x1b[0m             PostgreSQL, Supabase
\x1b[36m           '@@@@@@@@@@@@@@@@@@'           \x1b[0m
\x1b[36m              '#@@@@@@@@@@#'              \x1b[0m   \x1b[33mStatus\x1b[0m:   \x1b[32m●\x1b[0m Available for work
\x1b[36m                  '''''                   \x1b[0m
`);
        break;
  ...
  const resolvePath = (path: string): string => {
    ...
    if (path.startsWith('~')) return path.replace('~', '/home/mehrab');
      ...
      >
        {history.map((entry, index) => (
          <div key={index} className="whitespace-pre-wrap">
            <span dangerouslySetInnerHTML={{ __html: formatOutput(entry.content) }} />
          </div>
        ))}
