...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Real-time collaborative whiteboard built with React, TypeScript, HTML5 Canvas, and WebSockets (Node.js). Deployed on Vercel + Render with room-based sync and deterministic canvas rendering.",
    tags: ["React", "TypeScript", "Canvas", "WebSockets", "Node.js", "Vercel", "Render"],
    github: "https://github.com/mehrabgholamsamani/Boardly-Fullstack",
    live: "https://boardly-fullstack-client.vercel.app/?room=lobby",
    accent: "amber",
    art: "whiteboard",
