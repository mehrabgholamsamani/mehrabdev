...
import { Folder, Terminal, User, Wifi, WifiOff, Volume2, VolumeX, Volume1, Battery, BatteryCharging, Search, Code2, Settings, Briefcase, Mail, Camera, Mic, StickyNote, Gamepad2, Trash2, Info, FileText, RotateCcw, Maximize2, Grid3X3, HelpCircle, Calendar, Moon, Sun, Bluetooth, Zap } from 'lucide-react';
...
const Taskbar = ({ windows, activeWindowId, onWindowClick, onOpenApp }: TaskbarProps) => {
  ...
  const allApps = [
    ...
    { id: 'about', name: 'About Me', icon: <User className="w-5 h-5 text-purple-400" />, desc: 'Learn about Arsham' },
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <img src="/me.png" alt="Arsham" className="w-4 h-4 rounded-full object-cover" />
            <span className="text-[13px] font-semibold">Arsham OS</span>
          </button>
          ...
          <div className="relative">
            <button
              ...
              className={`px-2 py-1 rounded text-[13px] transition-colors ${activeMenu === 'edit' ? 'bg-white/20 text-white' : 'text-white/60 hover:bg-white/10 hover:text-white'}`}
            >
              Edit
            </button>
            {activeMenu === 'edit' && (
              <div className="absolute top-full left-0 mt-1 w-48 bg-gray-900/95 backdrop-blur-xl rounded-lg border border-white/10 shadow-2xl py-1 z-50">
                <button className="w-full flex items-center justify-between px-3 py-2 text-[13px] text-white/40 cursor-not-allowed">
                  <span>Undo</span><span className="text-[11px]">⌘Z</span>
                </button>
                <button className="w-full flex items-center justify-between px-3 py-2 text-[13px] text-white/40 cursor-not-allowed">
                  <span>Redo</span><span className="text-[11px]">⇧⌘Z</span>
                </button>
                <div className="h-px bg-white/10 my-1 mx-2" />
                <button className="w-full flex items-center justify-between px-3 py-2 text-[13px] text-white/40 cursor-not-allowed">
                  <span>Cut</span><span className="text-[11px]">⌘X</span>
                </button>
                <button className="w-full flex items-center justify-between px-3 py-2 text-[13px] text-white/40 cursor-not-allowed">
                  <span>Copy</span><span className="text-[11px]">⌘C</span>
                </button>
                <button className="w-full flex items-center justify-between px-3 py-2 text-[13px] text-white/40 cursor-not-allowed">
                  <span>Paste</span><span className="text-[11px]">⌘V</span>
                </button>
              </div>
            )}
          </div>
            ...
            {activeMenu === 'help' && (
              <div className="absolute top-full left-0 mt-1 w-52 bg-gray-900/95 backdrop-blur-xl rounded-lg border border-white/10 shadow-2xl py-1 z-50">
                <button onClick={() => { onOpenApp('about'); setActiveMenu(null); }} className="w-full flex items-center gap-3 px-3 py-2 text-[13px] text-white/80 hover:bg-white/10 hover:text-white">
                  <User className="w-4 h-4" /> About Arsham
                </button>
                ...
                <div className="h-px bg-white/10 my-1 mx-2" />
                <a href="https://github.com/Arsham1ho" target="_blank" rel="noopener noreferrer" className="w-full flex items-center gap-3 px-3 py-2 text-[13px] text-white/80 hover:bg-white/10 hover:text-white">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative">
            ...
            >
              {wifiConnected ? <Wifi className="w-4 h-4" /> : <WifiOff className="w-4 h-4 text-white/40" />}
          ...
          <button
            ...
            className="relative"
          >
            <img src="/me.png" alt="Arsham" className={`w-5 h-5 rounded-full object-cover ring-1 transition-all ${activeMenu === 'user' ? 'ring-white/40' : 'ring-white/20 hover:ring-white/30'}`} />
            {activeMenu === 'user' && (
              <div className="absolute top-full right-0 mt-1 w-48 bg-gray-900/95 backdrop-blur-xl rounded-xl border border-white/10 shadow-2xl py-2 z-50">
                <div className="px-3 py-2 border-b border-white/10">
                  <div className="flex items-center gap-2">
                    <img src="/me.png" alt="Arsham" className="w-8 h-8 rounded-full object-cover" />
                    <div>
                      <p className="text-[13px] font-medium text-white">Arsham</p>
